...
package id.wawestudio.ble_chat_copy.ble_service;
...
public class RBLService extends Service {
	...
	private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
		...
		public void onConnectionStateChange(BluetoothGatt gatt, int status,
                                            int newState) {
			String intentAction;
			Log.i(TAG, "onConnectionStateChange start: ");

			if (newState == BluetoothProfile.STATE_CONNECTED) {
				intentAction = ACTION_GATT_CONNECTED;
				broadcastUpdate(intentAction);
				Log.i(TAG, "Success Connected to GATT server.");
				...
				Toast.makeText(RBLService.this, "device disconnected", Toast.LENGTH_SHORT).show();
				broadcastUpdate(intentAction);
			}
		}
	...
	public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
		...
		Log.i(TAG, "readCharacteristic start : ");
	...
	public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
		...
		Log.i(TAG, "writeCharacteristic: start");
		Toast.makeText(this, "start write "+characteristic.toString(), Toast.LENGTH_SHORT).show();
